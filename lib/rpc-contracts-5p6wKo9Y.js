...
const RESEARCH_MANAGEMENT_INVOCATIONS = [
	...
	descriptor("removeDependency", [argsParameter("RemoveDependencyArgs", RemoveDependencyArgsSchema)], "RemoveDependencyResult", RemoveDependencyResultSchema)
];
/**
...
//#endregion
export { RegisterInteractionArgsSchema as $, GetGitHistoryArgsSchema as A, UpdateProjectMetadataArgsSchema as At, GetWorkstreamCurrentResultSchema as B, DismissNextActionResultSchema as C, UnbindProjectResultSchema as Ct, DropWorkstreamResultSchema as D, UpdateObjectiveResultSchema as Dt, DropWorkstreamArgsSchema as E, UpdateObjectiveArgsSchema as Et, GetResearchPlaneStateArgsSchema as F, UpdateWorkstreamResultSchema as Ft, PlaneError as G, InspectProjectDirectoryArgsSchema as H, GetResearchPlaneStateResultSchema as I, WorkstreamSnapshotSchema as It, PromoteNextActionResultSchema as J, ProjectSnapshotSchema as K, GetTopicArgsSchema as L, GetHubOverviewArgsSchema as M, UpdateTopicArgsSchema as Mt, GetPortfolioInterventionsArgsSchema as N, UpdateTopicResultSchema as Nt, GetCurrentFocusArgsSchema as O, UpdatePlanItemArgsSchema as Ot, GetPortfolioInterventionsResultSchema as P, UpdateWorkstreamArgsSchema as Pt, RESEARCH_CONTROL_PACKAGE as Q, GetWorkstreamArgsSchema as R, DismissNextActionArgsSchema as S, UnbindProjectArgsSchema as St, DismissPlanForkResultSchema as T, UpdateInterventionStateResultSchema as Tt, InspectProjectDirectoryResultSchema as U, HubOverviewResultSchema as V, PingResultSchema as W, QueryHistoryResultSchema as X, QueryHistoryArgsSchema as Y, REGISTERED_RESEARCH_INVOCATIONS as Z, CreateTopicArgsSchema as _, SetCurrentFocusArgsSchema as _t, BindProjectArgsSchema as a, ReorderPlanArgsSchema as at, CreateWorkstreamResultSchema as b, SetHubResultSchema as bt, ClearBlockerResultSchema as c, RescanResultSchema as ct, CreateLocalResearchProjectArgsSchema as d, RestoreProjectArgsSchema as dt, RegisterInteractionResultSchema as et, CreateLocalResearchProjectResultSchema as f, RestoreProjectResultSchema as ft, CreatePlanItemResultSchema as g, SelectPlanForkResultSchema as gt, CreatePlanItemArgsSchema as h, SelectPlanForkArgsSchema as ht, AddDependencyResultSchema as i, RemovePlanItemResultSchema as it, GetGitHistoryResultSchema as j, UpdateProjectMetadataResultSchema as jt, GetCurrentFocusResultSchema as k, UpdatePlanItemResultSchema as kt, CreateBlockerArgsSchema as l, RestoreDeclarativeFileArgsSchema as lt, CreateNextActionResultSchema as m, SaveResearchCheckpointResultSchema as mt, AckMissingReminderResultSchema as n, RemoveDependencyResultSchema as nt, BindProjectResultSchema as o, ReorderPlanResultSchema as ot, CreateNextActionArgsSchema as p, SaveResearchCheckpointArgsSchema as pt, PromoteNextActionArgsSchema as q, AddDependencyArgsSchema as r, RemovePlanItemArgsSchema as rt, ClearBlockerArgsSchema as s, RescanArgsSchema as st, AckMissingReminderArgsSchema as t, RemoveDependencyArgsSchema as tt, CreateBlockerResultSchema as u, RestoreDeclarativeFileResultSchema as ut, CreateTopicResultSchema as v, SetCurrentFocusResultSchema as vt, DismissPlanForkArgsSchema as w, UpdateInterventionStateArgsSchema as wt, DashboardSnapshotSchema as x, TopicSnapshotSchema as xt, CreateWorkstreamArgsSchema as y, SetHubArgsSchema as yt, GetWorkstreamCurrentArgsSchema as z };
