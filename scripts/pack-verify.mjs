 ...
 *     service class) + `./typert` (TYPERT manifest, 40 invocations = 39 RPC (13 frozen V1 + 9 plane + 17 GUI management) + ping) +
  ...
  const smoke = spawnSync(
    ...
    [
      ...
      [
        ...
        'if (T.invocations.length !== 40) throw new Error("./typert: expected 40 invocations (39 RPC: 13 frozen V1 + 9 plane + 17 GUI management, + ping), got " + T.invocations.length)',
