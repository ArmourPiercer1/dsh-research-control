 ...
 *     service class) + `./typert` (TYPERT manifest, 45 invocations = 44 RPC (13 frozen V1 + 9 plane + 22 GUI management) + ping) +
  ...
  const smoke = spawnSync(
    ...
    [
      ...
      [
        ...
        'if (T.invocations.length !== 45) throw new Error("./typert: expected 45 invocations (44 RPC: 13 frozen V1 + 9 plane + 22 GUI management, + ping), got " + T.invocations.length)',
