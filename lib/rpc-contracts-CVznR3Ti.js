...
const RESEARCH_MANAGEMENT_INVOCATIONS = [
	...
	descriptor("createLocalResearchProject", [argsParameter("CreateLocalResearchProjectArgs", CreateLocalResearchProjectArgsSchema)], "CreateLocalResearchProjectResult", CreateLocalResearchProjectResultSchema)
];
/**
...
//#endregion
export { SetHubArgsSchema as $, PingResultSchema as A, ReorderPlanResultSchema as B, GetResearchPlaneStateArgsSchema as C, HubOverviewResultSchema as D, GetWorkstreamArgsSchema as E, REGISTERED_RESEARCH_INVOCATIONS as F, RestoreProjectArgsSchema as G, RescanResultSchema as H, RESEARCH_CONTROL_PACKAGE as I, SaveResearchCheckpointResultSchema as J, RestoreProjectResultSchema as K, RegisterInteractionArgsSchema as L, ProjectSnapshotSchema as M, QueryHistoryArgsSchema as N, InspectProjectDirectoryArgsSchema as O, QueryHistoryResultSchema as P, SetCurrentFocusResultSchema as Q, RegisterInteractionResultSchema as R, GetPortfolioInterventionsResultSchema as S, GetTopicArgsSchema as T, RestoreDeclarativeFileArgsSchema as U, RescanArgsSchema as V, RestoreDeclarativeFileResultSchema as W, SelectPlanForkResultSchema as X, SelectPlanForkArgsSchema as Y, SetCurrentFocusArgsSchema as Z, GetCurrentFocusResultSchema as _, CreateLocalResearchProjectArgsSchema as a, UpdateInterventionStateResultSchema as at, GetHubOverviewArgsSchema as b, CreateTopicResultSchema as c, UpdateTopicArgsSchema as ct, DashboardSnapshotSchema as d, UpdateWorkstreamResultSchema as dt, SetHubResultSchema as et, DismissPlanForkArgsSchema as f, WorkstreamSnapshotSchema as ft, GetCurrentFocusArgsSchema as g, DropWorkstreamResultSchema as h, BindProjectResultSchema as i, UpdateInterventionStateArgsSchema as it, PlaneError as j, InspectProjectDirectoryResultSchema as k, CreateWorkstreamArgsSchema as l, UpdateTopicResultSchema as lt, DropWorkstreamArgsSchema as m, AckMissingReminderResultSchema as n, UnbindProjectArgsSchema as nt, CreateLocalResearchProjectResultSchema as o, UpdateProjectMetadataArgsSchema as ot, DismissPlanForkResultSchema as p, SaveResearchCheckpointArgsSchema as q, BindProjectArgsSchema as r, UnbindProjectResultSchema as rt, CreateTopicArgsSchema as s, UpdateProjectMetadataResultSchema as st, AckMissingReminderArgsSchema as t, TopicSnapshotSchema as tt, CreateWorkstreamResultSchema as u, UpdateWorkstreamArgsSchema as ut, GetGitHistoryArgsSchema as v, GetResearchPlaneStateResultSchema as w, GetPortfolioInterventionsArgsSchema as x, GetGitHistoryResultSchema as y, ReorderPlanArgsSchema as z };
