 ...
 * MergeContractStore kernels for the GUI mutation face — all five
 * faces live in this class (single-slice delivery:
 * `createWorkstreamFork` / `createPlannedMerge` / `getMergeContract` /
 * `saveMergeContract` / `dropTopologyEdge`; the D1-D5 split is a
 * work-package unit, not a temporal one).
 *
