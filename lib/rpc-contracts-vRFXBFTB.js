...
const RESEARCH_MANAGEMENT_INVOCATIONS = [
	...
	descriptor("dropTopologyEdge", [argsParameter("DropTopologyEdgeArgs", DropTopologyEdgeArgsSchema)], "DropTopologyEdgeResult", DropTopologyEdgeResultSchema)
];
/**
...
//#endregion
export { PlaneError as $, DropTopologyEdgeArgsSchema as A, SetHubResultSchema as At, GetMergeContractResultSchema as B, UpdateProjectMetadataArgsSchema as Bt, CreateWorkstreamForkResultSchema as C, SaveResearchCheckpointArgsSchema as Ct, DismissNextActionResultSchema as D, SetCurrentFocusArgsSchema as Dt, DismissNextActionArgsSchema as E, SelectPlanForkResultSchema as Et, GetCurrentFocusResultSchema as F, UpdateInterventionStateResultSchema as Ft, GetTopicArgsSchema as G, UpdateWorkstreamResultSchema as Gt, GetPortfolioInterventionsResultSchema as H, UpdateTopicArgsSchema as Ht, GetGitHistoryArgsSchema as I, UpdateObjectiveArgsSchema as It, GetWorkstreamCurrentResultSchema as J, GetWorkstreamArgsSchema as K, WorkstreamSnapshotSchema as Kt, GetGitHistoryResultSchema as L, UpdateObjectiveResultSchema as Lt, DropWorkstreamArgsSchema as M, UnbindProjectArgsSchema as Mt, DropWorkstreamResultSchema as N, UnbindProjectResultSchema as Nt, DismissPlanForkArgsSchema as O, SetCurrentFocusResultSchema as Ot, GetCurrentFocusArgsSchema as P, UpdateInterventionStateArgsSchema as Pt, PingResultSchema as Q, GetHubOverviewArgsSchema as R, UpdatePlanItemArgsSchema as Rt, CreateWorkstreamForkArgsSchema as S, SaveMergeContractResultSchema as St, DashboardSnapshotSchema as T, SelectPlanForkArgsSchema as Tt, GetResearchPlaneStateArgsSchema as U, UpdateTopicResultSchema as Ut, GetPortfolioInterventionsArgsSchema as V, UpdateProjectMetadataResultSchema as Vt, GetResearchPlaneStateResultSchema as W, UpdateWorkstreamArgsSchema as Wt, InspectProjectDirectoryArgsSchema as X, HubOverviewResultSchema as Y, InspectProjectDirectoryResultSchema as Z, CreatePlannedMergeArgsSchema as _, RestoreDeclarativeFileArgsSchema as _t, BindProjectArgsSchema as a, REGISTERED_RESEARCH_INVOCATIONS as at, CreateTopicResultSchema as b, RestoreProjectResultSchema as bt, ClearBlockerResultSchema as c, RegisterInteractionResultSchema as ct, CreateLocalResearchProjectArgsSchema as d, RemovePlanItemArgsSchema as dt, ProjectSnapshotSchema as et, CreateLocalResearchProjectResultSchema as f, RemovePlanItemResultSchema as ft, CreatePlanItemResultSchema as g, RescanResultSchema as gt, CreatePlanItemArgsSchema as h, RescanArgsSchema as ht, AddDependencyResultSchema as i, QueryHistoryResultSchema as it, DropTopologyEdgeResultSchema as j, TopicSnapshotSchema as jt, DismissPlanForkResultSchema as k, SetHubArgsSchema as kt, CreateBlockerArgsSchema as l, RemoveDependencyArgsSchema as lt, CreateNextActionResultSchema as m, ReorderPlanResultSchema as mt, AckMissingReminderResultSchema as n, PromoteNextActionResultSchema as nt, BindProjectResultSchema as o, RESEARCH_CONTROL_PACKAGE as ot, CreateNextActionArgsSchema as p, ReorderPlanArgsSchema as pt, GetWorkstreamCurrentArgsSchema as q, AddDependencyArgsSchema as r, QueryHistoryArgsSchema as rt, ClearBlockerArgsSchema as s, RegisterInteractionArgsSchema as st, AckMissingReminderArgsSchema as t, PromoteNextActionArgsSchema as tt, CreateBlockerResultSchema as u, RemoveDependencyResultSchema as ut, CreatePlannedMergeResultSchema as v, RestoreDeclarativeFileResultSchema as vt, CreateWorkstreamResultSchema as w, SaveResearchCheckpointResultSchema as wt, CreateWorkstreamArgsSchema as x, SaveMergeContractArgsSchema as xt, CreateTopicArgsSchema as y, RestoreProjectArgsSchema as yt, GetMergeContractArgsSchema as z, UpdatePlanItemResultSchema as zt };
