 ...
 *     service class) + `./typert` (TYPERT manifest, 33 invocations = 32 RPC (13 frozen V1 + 9 plane + 10 GUI management) + ping) +
  ...
  const smoke = spawnSync(
    ...
    [
      ...
      [
        ...
        'if (T.invocations.length !== 33) throw new Error("./typert: expected 33 invocations (32 RPC: 13 frozen V1 + 9 plane + 10 GUI management, + ping), got " + T.invocations.length)',
