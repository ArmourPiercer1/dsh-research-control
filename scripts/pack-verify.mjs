 ...
 *     service class) + `./typert` (TYPERT manifest, 27 invocations = 26 RPC (13 frozen V1 + 9 plane + 4 GUI management) + ping) +
  ...
  const smoke = spawnSync(
    ...
    [
      ...
      [
        ...
        'if (T.invocations.length !== 27) throw new Error("./typert: expected 27 invocations (26 RPC: 13 frozen V1 + 9 plane + 4 GUI management, + ping), got " + T.invocations.length)',
