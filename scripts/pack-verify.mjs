 ...
 *     service class) + `./typert` (TYPERT manifest, 25 invocations = 24 RPC (13 frozen V1 + 9 plane + 2 GUI management) + ping) +
  ...
  const smoke = spawnSync(
    ...
    [
      ...
      [
        ...
        'if (T.invocations.length !== 25) throw new Error("./typert: expected 25 invocations (24 RPC: 13 frozen V1 + 9 plane + 2 GUI management, + ping), got " + T.invocations.length)',
